...
public class VueloController {
    ...
    @GetMapping("/numeroAsientos/{idvuelo}")
    public int getNumeroAsientosVuelo(@PathVariable String idvuelo) {
        return this.vueloServiceImpl.numeroAsientosVuelo(idvuelo);
    }
}
